...
# Create or reference a namespace for our component
...
CONFIG_SCHEMA = cv.All(
    # This sensor schema ensures we have a PollingComponent
...
# IMPORTANT: We define this function as async now
async def to_code(config):
    var = cg.new_Pvariable(config[CONF_ID])
    # We await these calls because they are now coroutines
